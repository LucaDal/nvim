return{
    ...
    config = function ()
        ...
        vim.keymap.set("n", "<C-a>", function() harpoon:list():add() end, {desc = 'Harpoon: Add current file to harpoon List'})
        ...
        vim.keymap.set("n", "<C-A-p>", function() harpoon:list():prev() end, {desc = 'Harpoon: Next file'})
